...
{
	//Start WorldChat Functions
	if (sWorld.getConfig(CONFIG_BOOL_WORLDCHAT_ENABLED))
	{
		if (!*args)
			return false;
		...
		PSendSysMessage("世界聊天發送成功，消耗%u銅。", sWorld.getConfig(CONFIG_UINT32_WORLDCHAT_COST));
