...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_WORLDCHAT_COST, //世界聊天消耗費用
    CONFIG_UINT32_WORLDCHAT_MIN_LEVEL, //世界聊天要求等級
...
enum eConfigBoolValues
{
	...
	//End Solocraft Defines
	//Start Worldchat Defines
	CONFIG_BOOL_WORLDCHAT_ENABLED,
	CONFIG_BOOL_WORLDCHAT_ANNOUNCE,
	//End Worldchat Defines
    ...
    CONFIG_BOOL_INSTANT_TAXI, //Instant flight 瞬飛
