...
const char* Transmogrification::GetSlotName(uint8 slot, WorldSession* /*session*/) const
{
    switch (slot)
    {
    case EQUIPMENT_SLOT_HEAD: return  "頭部";// session->GetAcoreString(LANG_SLOT_NAME_HEAD);
    case EQUIPMENT_SLOT_SHOULDERS: return  "肩膀";// session->GetAcoreString(LANG_SLOT_NAME_SHOULDERS);
    case EQUIPMENT_SLOT_BODY: return  "襯衣";// session->GetAcoreString(LANG_SLOT_NAME_BODY);
    ...
    case EQUIPMENT_SLOT_FEET: return  "腳部";// session->GetAcoreString(LANG_SLOT_NAME_FEET);
    ...
    case EQUIPMENT_SLOT_BACK: return  "披風";// session->GetAcoreString(LANG_SLOT_NAME_BACK);
    case EQUIPMENT_SLOT_MAINHAND: return  "主手";// session->GetAcoreString(LANG_SLOT_NAME_MAINHAND);
    case EQUIPMENT_SLOT_OFFHAND: return  "副手/盾";// session->GetAcoreString(LANG_SLOT_NAME_OFFHAND);
    case EQUIPMENT_SLOT_RANGED: return  "遠程";// session->GetAcoreString(LANG_SLOT_NAME_RANGED);
    case EQUIPMENT_SLOT_TABARD: return  "戰袍";// session->GetAcoreString(LANG_SLOT_NAME_TABARD);
